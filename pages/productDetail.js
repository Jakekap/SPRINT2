...
const productId = Number(new URLSearchParams(url).get("id"));
...
imgPrincipal.addEventListener("click", (el) => {
  ...
  miniImage1.src = currentProduct.imagen0;
  miniImage2.src = currentProduct.imagen1;
  miniImage3.src = currentProduct.imagen2;
  miniImage4.src = currentProduct.imagen3;
});
...
async function getDetailData(productId, products) {
...
getDetailData(productId, allProducts);
